/* 「ポジションごとの優先スタッフ（①②③）」の検証
   ...
   2. 落合：オープン＝鈴木勇気／カレーパン＝3人のうち1人／外販＝優先順で1人
...
/* ---------- 2. 落合：要望どおりの初期値 ---------- */
sec("2. 落合：オープン＝鈴木勇気／カレーパン＝1人／外販＝1人");
{
  const { S } = env("ochiai", OCHIAI);
  eq(S.prioOf("p1").map((i) => S.staffBy(i).name), ["鈴木勇気"], "オープンの優先＝鈴木勇気");
