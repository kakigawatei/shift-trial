...
sec("4. 空きを優先しすぎて、時間帯の合わないポジションに置いていないか");
{
  ...
  /* 9:00-14:00 の人をどこに置くか。時間の合う順は 外販(8:00-14:00) → 昼③(8:30-15:00) */
  seed(S, "ochiai");
  eq(S.freePos([], 540, 840, "s0", 17), "p10", "空いていれば、いちばん時間の合う外販(8:00-14:00)");
  eq(S.freePos([{ pos: "p10", f: "05:00", t: "06:00" }], 540, 840, "s0", 17), "p5",
     "外販に先客がいれば、次に時間の合う昼③へ（同じ所に重ねない）");
